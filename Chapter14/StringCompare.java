public class StringCompare {
    public static void main(String[] args) {
        ...
        else System.out.println("s1 does not eqaul \"hello\"");
        ...
        else System.out.println("s3 does not equla s4");
        ...
        else System.out.println("First 5 characters of s3 and s4 do not match");
